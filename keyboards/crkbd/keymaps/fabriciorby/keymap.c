...
const uint16_t PROGMEM esc_combo[] = {RSFT_T(KC_J), RCMD_T(KC_K), COMBO_END};
const uint16_t PROGMEM tab_combo[] = {LCMD_T(KC_D), LSFT_T(KC_F), COMBO_END};
...
LCTL_T(KC_A), LALT_T(KC_S), LCMD_T(KC_D), LSFT_T(KC_F), LSA_T(KC_G),     LSA_T(KC_H), RSFT_T(KC_J), RCMD_T(KC_K), RALT_T(KC_L), RCTL_T(KC_SEMICOLON),
LT(HEL,KC_Z),         KC_X,         KC_C,         KC_V,        KC_B,            KC_N,         KC_M,      KC_COMM,       KC_DOT,      LT(HEL,KC_SLSH),
    ...
    [MEDIA] = LAYOUT_split_3x5_3(
     ...
     KC_LCTL, KC_LALT, KC_LCMD, KC_LSFT,   KC_NO,                             KC_MRWD, KC_VOLD, KC_VOLU, KC_MFFD,   KC_NO,
       KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                               KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
                                  KC_NO,   KC_NO,   KC_NO,           KC_MSTP,   KC_MPLY,  KC_MUTE
    ),
    [NAV] = LAYOUT_split_3x5_3(
       KC_NO,   KC_NO, DT_DOWN,   DT_UP,DT_PRNT,                               KC_UNDO,    KC_PSTE,    KC_COPY,  KC_CUT,   KC_REDO,
     KC_LCTL, KC_LALT, KC_LCMD, KC_LSFT, KC_CAPS_LOCK,                          KC_LEFT,    KC_DOWN,    KC_UP,    KC_RIGHT, KC_CAPS_LOCK,
       KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                               KC_INSERT,  KC_PGDN,    KC_PGUP,  KC_HOME,  KC_END,
                                  KC_NO,   KC_NO,   KC_NO,            KC_ENTER, KC_BSPC,    KC_DELETE
    ),
    [MOUSE] = LAYOUT_split_3x5_3(
       KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                               KC_UNDO,  KC_PSTE,  KC_COPY,  KC_CUT,   KC_REDO,
     KC_LCTL, KC_LALT, KC_LCMD, KC_LSFT, KC_CAPS_LOCK,                          KC_MS_L,  KC_MS_D,  KC_MS_U,  KC_MS_R,  KC_NO,
...
LSFT(KC_QUOTE),    LSFT(KC_4), LSFT(KC_5), LSFT(KC_6), LSFT(KC_EQUAL),          KC_NO,   KC_RSFT,  KC_RCMD,  KC_RALT,  KC_RCTL,
LSFT(KC_GRAVE),    LSFT(KC_1), LSFT(KC_2), LSFT(KC_3), LSFT(KC_BACKSLASH),      KC_NO,   KC_NO,    KC_NO,    KC_NO,    KC_NO,
    ...
    [NUM] = LAYOUT_split_3x5_3(
        ...
        KC_QUOTE, KC_4, KC_5, KC_6, KC_EQUAL,                                   KC_NO,  KC_RSFT,  KC_RCMD,  KC_RALT,  KC_RCTL,
    ...
    [FUN] = LAYOUT_split_3x5_3(
        ...
        KC_SCROLL_LOCK, KC_F4,    KC_F5,    KC_F6,    KC_F11,                    KC_NO,  KC_RSFT,  KC_RCMD,  KC_RALT,  KC_RCTL,
        KC_PAUSE,       KC_F1,    KC_F2,    KC_F3,    KC_F12,                    KC_NO,  KC_NO,      KC_NO,    KC_NO,    KC_NO,
                                    LCMD(KC_SPACE), KC_SPACE, KC_TAB,    KC_NO,  KC_NO,  KC_NO
    ),
