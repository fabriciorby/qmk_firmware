...
__attribute__((weak)) void st7565_task_user(void) {
    if (!is_keyboard_master()) {
        ...
        static int frame = 0;
        static const char qmk_logos[3][64] = {
            {
            0x92, 0x93, 0x92, 0x93, 0x92, 0x93, 0x92, 0x80, 0x81, 0x82, 0x83, 0x84, 0x85, 0x94, 0x94, 0x9B, 0x9C, 0x9D, 0x9E, 0x94, 0x94,
            0xB2, 0xB3, 0xB2, 0xB3, 0xB2, 0xB3, 0xB2, 0xA0, 0xA1, 0xA2, 0xA3, 0xA4, 0xA5, 0x94, 0x94, 0xBB, 0xBC, 0xBD, 0xBE, 0x94, 0x94,
            0xD2, 0xD3, 0xD2, 0xD3, 0xD2, 0xD3, 0xD2, 0xC0, 0xC1, 0xC2, 0xC3, 0xC4, 0xC5, 0x94, 0x94, 0xDB, 0xDC, 0xDD, 0xDE, 0x94, 0x94, 0x00
        },
        {
            0x92, 0x93, 0x92, 0x93, 0x92, 0x93, 0x92, 0x86, 0x87, 0x88, 0x89, 0x8A, 0x8B, 0x94, 0x94, 0x9B, 0x9C, 0x9D, 0x9E, 0x94, 0x94,
            0xB2, 0xB3, 0xB2, 0xB3, 0xB2, 0xB3, 0xB2, 0xA6, 0xA7, 0xA8, 0xA9, 0xAA, 0xAB, 0x94, 0x94, 0xBB, 0xBC, 0xBD, 0xBE, 0x94, 0x94,
            0xD2, 0xD3, 0xD2, 0xD3, 0xD2, 0xD3, 0xD2, 0xC6, 0xC7, 0xC8, 0xC9, 0xCA, 0xCB, 0x94, 0x94, 0xDB, 0xDC, 0xDD, 0xDE, 0x94, 0x94, 0x00
        },

        {
            0x93, 0x92, 0x93, 0x92, 0x93, 0x92, 0x93, 0x8C, 0x8D, 0x8E, 0x8F, 0x90, 0x91, 0x94, 0x94, 0x9B, 0x9C, 0x9D, 0x9E, 0x94, 0x94,
            0xB3, 0xB2, 0xB3, 0xB2, 0xB3, 0xB2, 0xB3, 0xAC, 0xAD, 0xAE, 0xAF, 0xB0, 0xB1, 0x94, 0x94, 0xBB, 0xBC, 0xBD, 0xBE, 0x94, 0x94,
            0xD3, 0xD2, 0xD3, 0xD2, 0xD3, 0xD2, 0xD3, 0xCC, 0xCD, 0xCE, 0xCF, 0xD0, 0xD1, 0x94, 0x94, 0xDB, 0xDC, 0xDD, 0xDE, 0x94, 0x94, 0x00
        }};
        if (timer_elapsed(anim_timer) > 240) {
        ...
        st7565_write(qmk_logos[frame], false);
